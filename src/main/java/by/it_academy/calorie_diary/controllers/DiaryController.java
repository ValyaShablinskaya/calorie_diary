...
public class DiaryController {
    ...
    @PostMapping
    protected ResponseEntity<DiaryDTO> createDiary(@Valid @PathVariable UUID uuid_profile, @RequestBody DiaryRequestDTO data) {
        DiaryDTO created = this.service.create(data, uuid_profile);
        return new ResponseEntity<>(created, HttpStatus.CREATED);
    }

    @GetMapping
    protected ResponseEntity<PageDTO<DiaryDTO>> getListOfDiary(@PathVariable UUID uuid_profile, Pageable pageable) {
